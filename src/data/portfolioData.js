...
const portfolios = [
  {
    ...
    description: `
    This project aims to give a real-world scenario to read and write to your disk via a Node.js express server rather than a database.The project serves two purposes: prepares for setting up scalable code and architecture for real-world projects and ties together some of the most popular middleware and utilities found in Node.js projects.
    
    ** I independently executed the project, handling all aspects from initiation to completion without collaboration.
  `,
  ...
  },
  {
    ...
    description: `MyStore is a single-page web application built with Angular, offering a user-friendly and interactive shopping experience. It features a variety of functionalities, including viewing a list of products, adding products to a cart, reviewing the cart contents, removing items from the cart, and completing the checkout process. The application emphasizes a seamless and efficient online shopping journey.
